sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("priyan/ZPO/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("priyan.ZPO.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["priyan/ZPO/localService/mockserver"], function (mockserver) {
