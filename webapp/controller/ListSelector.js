sap.ui.define([
		...
		"use strict";
		return BaseObject.extend("priyan.ZPO.controller.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias priyan.ZPO.controller.ListSelector
			 */
			 ...
			 * @return {priyan.ZPO.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
